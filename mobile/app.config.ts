...
export default (): ExpoConfig => ({
  name: "JARVIS Scolaire",
  slug: "jarvis-scolaire-mobile",
  scheme: "jarvis-scolaire",
  ...
  ios: {
    ...
    bundleIdentifier: "com.ninja959999.jarvisscolaire",
    associatedDomains: ["applinks:getpapillon.xyz"],
    infoPlist: {
      CFBundleURLTypes: [
        {
          CFBundleURLSchemes: ["jarvis-scolaire", "izly"],
        },
      ],
    },
    splash: {
  ...
  android: {
    ...
    intentFilters: [
      {
        action: "VIEW",
        data: [{ scheme: "jarvis-scolaire" }, { scheme: "izly" }],
    ...
    package: "com.ninja959999.jarvisscolaire",
    permissions: [
